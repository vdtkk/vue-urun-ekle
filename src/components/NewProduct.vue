...
export default{
     ...
     methods: {
        onChange(e) {
            const file = e.target.files[0]; // dosya seçtiğimizde seçtiğimz dosya adetini arraya alır.
            this.product.selectedImage = URL.createObjectURL(file); //url'sini almak için URL sınıfını kullanıyoruz.
        },
